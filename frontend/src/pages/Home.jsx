...
import { Heart, Users, DollarSign, Globe, ArrowRight, TrendingUp, Award, Shield, IndianRupee } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-900 transition-colors">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-emerald-100 leading-relaxed">
              Join our global community of changemakers. Support causes you care about and create lasting impact around the world.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div className="p-6 rounded-2xl bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-100 dark:border-green-800">
              ...
              <div className="text-gray-600 dark:text-dark-300 font-medium">Total Raised</div>
            </div>
            <div className="p-6 rounded-2xl bg-linear-to-br from-blue-50 to-emerald-50 dark:from-blue-900/20 dark:to-emerald-900/20 border border-blue-100 dark:border-blue-800">
              ...
              <div className="text-gray-600 dark:text-dark-300 font-medium">Active Donors</div>
            </div>
            <div className="p-6 rounded-2xl bg-linear-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-100 dark:border-emerald-800">
              ...
              <div className="text-gray-600 dark:text-dark-300 font-medium">Active Campaigns</div>
            </div>
            <div className="p-6 rounded-2xl bg-linear-to-br from-blue-50 to-emerald-50 dark:from-blue-900/20 dark:to-emerald-900/20 border border-blue-100 dark:border-blue-800">
              <div className="bg-linear-to-br from-blue-500 to-emerald-600 rounded-2xl w-16 h-16 flex items-center justify-center mx-auto mb-4 shadow-lg">
              ...
              <div className="text-gray-600 dark:text-dark-300 font-medium">Countries</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50 dark:bg-dark-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Featured Campaigns</h2>
      ...
      <section className="py-16 bg-white dark:bg-dark-800 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-dark-300">Simple steps to make a difference</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-linear-to-br from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-100 dark:border-emerald-800">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Discover Causes</h3>
              <p className="text-gray-600 dark:text-dark-300">Browse through verified campaigns and find causes that resonate with your values.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-100 dark:border-green-800">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Make an Impact</h3>
              <p className="text-gray-600 dark:text-dark-300">Donate securely and watch your contribution make a real difference in people's lives.</p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-linear-to-br from-blue-50 to-emerald-50 dark:from-blue-900/20 dark:to-emerald-900/20 border border-blue-100 dark:border-blue-800">
              ...
              <p className="text-gray-600 dark:text-dark-300">Receive updates on how your donation is being used and see the impact you've created.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-linear-to-br from-gray-50 to-emerald-50 dark:from-dark-900 dark:to-emerald-900/20 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Why Choose CauseConnect?</h2>
            <p className="text-lg text-gray-600 dark:text-dark-300">Trusted by thousands of donors and fundraisers worldwide</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Secure & Trusted</h3>
              <p className="text-gray-600 dark:text-dark-300">Bank-level security with verified campaigns and transparent fund tracking.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Real Impact</h3>
              <p className="text-gray-600 dark:text-dark-300">See exactly how your donations are used with regular updates and progress reports.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600 dark:text-dark-300">Recognized platform with the highest success rate for fundraising campaigns.</p>
            </div>
          </div>
        </div>
      </section>
